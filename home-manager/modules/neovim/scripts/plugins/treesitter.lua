...
local function move_binding(key, action, desc)
    local new_action = function() return action(require("nvim-treesitter-textobjects.move")) end
...
move_binding(
    "[a",
    function(x) x.goto_previous_start("@parameter.inner", "textobjects") end,
    "Go to previous parameter start"
)
move_binding(
    "[q",
    function(x) x.goto_previous_start("@function.outer", "textobjects") end,
...
move_binding(
    "[A",
    function(x) x.goto_previous_end("@parameter.inner", "textobjects") end,
    "Go to previous parameter end"
)
