...

{
  nix.sshServe = {
    ...
    keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICkPHjbJ0u8DnHV6CQspQGxSlT4Rz+k+Fv0atjlRiBfH ivv@nixos-framework"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHoj8S0NR1yUVti1jGMGW86ybC6gIko9kUnQT+MMXYO2 root@nixos-framework"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEhji5VHxSggfUkuZtkt3VztQyp4LzJFmSdnu6Gzrq1T root@nixos-framework"
    ];
  };
}
